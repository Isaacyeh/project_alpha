...
Preview: You can download all the code directly off of Github then open index.html.
...
Local host: Go to your preffered IDE, connect this repo and open a local host. step by step (simplest way):
